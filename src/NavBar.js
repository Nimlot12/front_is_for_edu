...
const NavBar = ({user, setUser}) => {
    ...
    return (
        <nav className="nav-bar">  {/* Блок nav-bar */}
            <div className="nav-bar__logo-container">
                <img src={logo} alt="SchoolDOT Logo" className="nav-bar__logo" />
            </div>
            <ul className="nav-bar__menu">
                <li className="nav-bar__item">
                    <NavLink to="/lead_page" end
                             className={({ isActive }) =>
                ...
                <li className="nav-bar__item">
                    <NavLink to="/lead_page/teach_panel"
                             className={({ isActive }) =>
                                 `nav-bar__link ${isActive ? 'nav-bar__link--active' : ''}`
                             }>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li className="nav-bar__item">
                    <NavLink to="/lead_page/Admin_page"
                             className={({ isActive }) =>
                                 `nav-bar__link ${isActive ? 'nav-bar__link--active' : ''}`
                             }>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div className="nav-bar__footer">
                <a href="#" className="nav-bar__logout" onClick={handleLogout}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
